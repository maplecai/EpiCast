"""fig1C, mean +- SD variant: how strongly each VEF tracks measured CRE activity.

Identical to fig1c_vef_activity_correlation.py except that the five cell-type values are
...
fig_name = "fig1c_vef_activity_correlation_mean.pdf"
