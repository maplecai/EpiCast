...
if __name__ == '__main__':
    ...
    config_path = 'configs/config_0314_SirajMPRA_one_cell_type.yaml'
    ...
    for cell_type in ['K562', 'SK-N-SH', 'HepG2', 'A549', 'HCT116']:
        ...
        subprocess.run(
            f'OMP_NUM_THREADS=4 torchrun --nnodes=1 --nproc_per_node=4 {script_path} -c {new_config_path};',
            shell=True)
