...
my_df = pd.read_csv('data/Gosai_MPRA/Gosai_MPRA_reprocessed_0203.tsv', sep='\t')
print('my processed dataset')
print(my_df.shape)
print(my_df.columns)
print(my_df[my_df['id'].duplicated(keep=False)])
...
print(original_df[original_df['id'].duplicated(keep=False)])
...
# print(len(original_df[original_df['seq'].str.len() == 200]))
...
for cell_type in cell_types:
    r, _ = genoml.metrics.pearson(merged_df[f'{cell_type}_x'], merged_df[f'{cell_type}_y'])
